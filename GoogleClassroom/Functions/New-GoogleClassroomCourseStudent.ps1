...
# userIds,yes,string,Comma delimited list of user IDs for each student you want added to the course. It can be any one of the following:
# --the numeric identifier for the user
# --the email address of the user
# --the string literal "me", indicating the requesting user

function New-GoogleClassroomCourseStudent
{ 
    [cmdletbinding()]
    param(
