Function Connect-GoogleClassroom
{
        <#
        .LINK
        https://github.com/Sekers/GoogleClassroomAPI

        .SYNOPSIS
        Google API - Verify cached tokens exist and are not expired using Connect-GoogleClassroom.
        Connect-GoogleClassroom will automatically refresh tokens or reauthenticate to the Google API service, if necessary.
        ...
        .EXAMPLE
        Connect-GoogleClassroom -ForceReauthentication
        .EXAMPLE
        Connect-GoogleClassroom -ForceReauthentication -ClearBrowserControlCache
        .EXAMPLE
        Connect-GoogleClassroom -ForceReauthentication -AuthenticationMethod MiniHTTPServer
        .EXAMPLE
    ...
    Param(
        ...
        ValueFromPipeline=$true,
        ValueFromPipelineByPropertyName=$true)]
        [ValidateSet('EdgeWebView2','MiniHTTPServer')]
    ...
    process
    {
        ...
        {
            Get-GoogleAPINewTokens -google_classroom_api_tokens_file_path $google_clasroom_api_tokens_file_path -AuthenticationMethod $AuthenticationMethod -ClearBrowserControlCache:$ClearBrowserControlCache
        }
