# Sample Google Classroom PowerShell Module Usage Script

<#
    Import the Module
#>
# Import-Module GoogleClassroom
# Import-Module "$PSScriptRoot\..\GoogleClassroom\GoogleClassroom.psm1"

<#
    Retrieve the Google Classroom Module Configuration File
#>
# Get-GoogleClassroomConfig -ConfigPath '.\Sample_Usage_Scripts\Config\google_classroom_api_config.json'
