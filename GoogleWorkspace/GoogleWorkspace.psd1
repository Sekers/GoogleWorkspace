#
# Module manifest for module 'GoogleWorkspace'
#
...
GUID = '7a5c8f58-4e84-4b9f-8d16-fdbcbc0811ff'
...
Description = 'PowerShell Module for the Google Workspace API'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("API", 'PowerShell', 'Google', "GoogleWorkspace", "Workspace")

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/Sekers/GoogleWorkspace/blob/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/Sekers/GoogleWorkspace'
